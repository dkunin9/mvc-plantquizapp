...
class ResultVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: Constants.recordNibName, bundle: nil), forCellReuseIdentifier: Constants.recordCellIdentifier)
    }
...
extension ResultVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: Constants.recordCellIdentifier, for: indexPath) as! RecordCell
        if indexPath.row == 0 {
